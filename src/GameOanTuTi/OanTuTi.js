    ...
    render() {
        ...
        return (
            <div className=" pt-5 pb-2 bx">
                <div>
                    <div>
                        <img style={{ backgroundColor: "white", padding: 40, width: "40%", border: '2px solid green' }} src={this.props.banChon.find(item => item.datCuoc === true).hinhAnh}></img>
                    </div>
                    ...
                    <div>
                        {this.props.banChon.map((banChon, index) => {
                            ...
                            }} key={index} className="mx-2" style={{ backgroundColor: 'white', border: '2px solid green', width: 50, borderRadius: 8 }} src={banChon.hinhAnh}></img>
                        })}
                    </div>
                </div>
            </div>
